...
<body>
    ...
    <div class="container">
        ...
        {{--=========================== Class 58 (Alert Success Message) ==================================--}}
                ...
                <form id="form" action="{{ route('posts.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="Is_active" id="">
                            ...
                            <option @selected(old('Is_active') == 2) value="2">No</option>
                        </select>
                    </div>
        ...
        {{--=========================== Class 47 ==================================--}}
        {{-- <a class="btn btn-info py-2 px-5" href="test-2">Go</a> --}}

        {{-- <a class="btn btn-info py-2 px-5" href="{{ url('test-2') }}">Go</a> --}}

        {{-- <a class="btn btn-info py-2 px-5" href="{{ route('different-by-name') }}">Go</a> --}}
